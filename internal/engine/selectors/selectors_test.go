...
type testSelectorEntityBuilder func() *minderv1.SelectorEntity
type testRepoOption func(selRepo *minderv1.SelectorEntity_SelectorRepository)
type testArtifactOption func(selArtifact *minderv1.SelectorEntity_SelectorArtifact)

func newTestArtifactSelectorEntity(artifactOpts ...testArtifactOption) testSelectorEntityBuilder {
	return func() *minderv1.SelectorEntity {
		artifact := &minderv1.SelectorEntity{
		...
		for _, opt := range artifactOpts {
			opt(artifact.Entity.(*minderv1.SelectorEntity_Artifact).Artifact)
		}
...
func newTestRepoSelectorEntity(repoOpts ...testRepoOption) testSelectorEntityBuilder {
	return func() *minderv1.SelectorEntity {
		...
		for _, opt := range repoOpts {
			opt(repo.Entity.(*minderv1.SelectorEntity_Repository).Repository)
		}
...
func withIsFork(isFork bool) testRepoOption {
	return func(selRepo *minderv1.SelectorEntity_SelectorRepository) {
